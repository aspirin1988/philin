...
class Inventor_Google_Map_Scripts {
	...
	public static function enqueue_frontend() {
		...
		wp_enqueue_script( 'jquery-google-map', plugins_url( '/inventor-google-map/libraries/jquery-google-map/jquery-google-map.js' ), array( 'jquery' ), '20160605', true );
		wp_enqueue_script( 'inventor-google-map', plugins_url( '/inventor-google-map/assets/js/inventor-google-map.js' ), array( 'jquery' ), '20160605', true );
	}
}
