...
class Inventor_Fields_Post_Type_Metabox {
    ...
    public static function fields() {
        ...
        $listing_types_enabled = Inventor_Post_Types::get_listing_post_types();

        foreach ( Inventor_Post_Types::get_all_listing_post_types() as $post_type ) {
            $is_enabled = in_array( $post_type->name, $listing_types_enabled );
            if ( $post_type->show_in_menu === 'listings' && $is_enabled ) {
