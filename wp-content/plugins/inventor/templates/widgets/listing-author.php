...
<?php if ( ! empty( $image ) || ! empty( $first_name ) || ! empty( $last_name ) || ! empty( $email ) || ! empty( $website ) || ! empty( $social ) ): ?>
	...
	<?php echo ( empty( $instance['padding_bottom'] ) ) ? '' : 'widget-pb' ; ?>"
		...
		<div class="listing-author">
			<?php if ( ! empty( $image ) ) : ?>
				<div class="listing-author-image" data-background-image="<?php echo esc_attr( $image ); ?>">
