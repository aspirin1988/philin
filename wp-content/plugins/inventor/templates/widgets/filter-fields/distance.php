<?php if ( empty( $instance['hide_distance'] ) ) : ?>
	<div class="form-group form-group-distance">
		...
		<input type="hidden" name="distance-latitude" value="<?php if ( ! empty( $instance['latitude'] ) ) : ?><?php echo esc_attr( $instance['latitude'] ); ?><?php endif; ?>">
		<input type="hidden" name="distance-longitude" value="<?php if ( ! empty( $instance['longitude'] ) ) : ?><?php echo esc_attr( $instance['longitude'] ); ?><?php endif; ?>">
	</div><!-- /.form-group -->
<?php endif; ?>