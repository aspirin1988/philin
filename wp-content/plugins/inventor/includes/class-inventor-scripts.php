...
class Inventor_Scripts {
	...
	public static function enqueue_frontend() {
		wp_enqueue_script( 'inventor', plugins_url( '/inventor/assets/js/inventor.js' ), array( 'jquery' ), '20160606', true );
		wp_enqueue_style( 'inventor-poi', plugins_url( '/inventor/assets/fonts/inventor-poi/style.css' ) );
		wp_enqueue_script( 'masonry', plugins_url( '/inventor-testimonials/assets/libraries/masonry.min.js' ), array( 'jquery' ), false, true );
	...
	public static function enqueue_backend( $hook ) {
		...
		wp_enqueue_style( 'inventor-admin', plugins_url( '/inventor/assets/css/inventor-admin.css' ) );
		wp_enqueue_script( 'inventor-admin', plugins_url( '/inventor/assets/js/inventor-admin.js' ), array( 'jquery' ), '20160531', true );
