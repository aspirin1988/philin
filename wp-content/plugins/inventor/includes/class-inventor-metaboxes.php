...
class Inventor_Metaboxes {
	...
	public static function metabox_general( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			...
			'description'   => apply_filters( 'inventor_metabox_description', __( 'General information about the listing. Enter its title, description and featured image.', 'inventor' ), $metabox_id ),
	...
	public static function metabox_faq( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'FAQ', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'List of most frequently asked questions.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'          => true,
	...
	public static function metabox_branding( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Branding', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Specific listing details like logo, slogan or its own color.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
		) );
	...
	public static function metabox_banner( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Banner', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Choose banner type which will be displayed in the listing detail page.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'          => true,
		...
		if ( apply_filters( 'inventor_metabox_field_enabled', true, $metabox_id, $field_id, $post_type ) ) {
			...
			$field_id =INVENTOR_LISTING_PREFIX . 'banner_video_loop';
			$field_name = __('Loop', 'inventor');

			$cmb->add_field(array(
				'id' 			=> $field_id,
				'type' 			=> 'checkbox',
				'name'          => apply_filters( 'inventor_metabox_field_name', $field_name, $metabox_id, $field_id, $post_type ),
				'description'   => apply_filters( 'inventor_metabox_field_description', __( 'Check to loop video', 'inventor' ), $metabox_id, $field_id, $post_type ),
				'default' 		=> apply_filters( 'inventor_metabox_field_default', null, $metabox_id, $field_id, $post_type ),
				'attributes' 	=> apply_filters( 'inventor_metabox_field_attributes', array(), $metabox_id, $field_id, $post_type ),
				'row_classes' 	=> 'cmb-row-banner banner-video'
			));
	...
	public static function metabox_gallery( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Gallery', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Upload some photos into listing gallery.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'          => true,
	...
	public static function metabox_color( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Color', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Listing color definition.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
		) );
	...
	public static function metabox_video( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Video', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'If you wish, you can enter listing video URL here.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'          => true,
	...
	public static function metabox_listing_category( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Listing categories', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Assign listing into category. It will help users to find it.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
		) );
		...
		$cmb->add_field( array(
			...
			'name'              => apply_filters( 'inventor_metabox_field_name', $field_name, $metabox_id, $field_id, $post_type ),
			'description'   	=> apply_filters( 'inventor_metabox_field_description', null, $metabox_id, $field_id, $post_type ),
			'type'              => apply_filters( 'inventor_metabox_field_type', 'taxonomy_multicheck_hierarchy', $metabox_id, $field_id, $post_type ),
			'default'           => apply_filters( 'inventor_metabox_field_default', null, $metabox_id, $field_id, $post_type ),
			'attributes'        => apply_filters( 'inventor_metabox_field_attributes', array(), $metabox_id, $field_id, $post_type ),
		) );
	}
	...
	public static function metabox_opening_hours( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Opening Hours', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Let people know when it is open.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'          => true,
	...
	public static function metabox_contact( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Contact', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Enter some details how can people reach the listing.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'			=> true
	...
	public static function metabox_social( $post_type ) {
		...
		$social = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Social', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Connections to social networks.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'			=> true
	...
	public static function metabox_price( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Price', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Define listing price here.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
			'skip'          => true,
	...
	public static function metabox_location( $post_type ) {
		...
		$cmb = new_cmb2_box( array(
			'id'            => $metabox_id,
			'title'			=> apply_filters( 'inventor_metabox_title', __( 'Location', 'inventor' ), $metabox_id ),
			'description'   => apply_filters( 'inventor_metabox_description', __( 'Set location of the listing. It will help people to find it.', 'inventor' ), $metabox_id ),
			'object_types'  => array( $post_type ),
			'context'       => 'normal',
			'priority'      => 'high',
		) );
		...
		if ( apply_filters( 'inventor_metabox_field_enabled', true, $metabox_id, $field_id, $post_type ) ) {
			...
			if ( apply_filters( 'inventor_metabox_field_enabled', true, $metabox_id, $field_id, $post_type ) ) {
				...
				$cmb->add_field( array(
					...
					'type'              => 'text',
					'name'   			=> apply_filters( 'inventor_metabox_field_name', $field_name, $metabox_id, $field_id, $post_type ),
					'description'   	=> apply_filters( 'inventor_metabox_field_description', __( 'Enter encoded path. It can be constructed using <a href="https://google-developers.appspot.com/maps/documentation/utilities/polylineutility_6dfa1f29011ecf2cf389dba27e343637.frame?hl=en&redesign=true" target="_blank">Interactive Polyline Encoder Utility</a>.', 'inventor' ), $metabox_id, $field_id, $post_type ),
					'default'           => apply_filters( 'inventor_metabox_field_default', null, $metabox_id, $field_id, $post_type ),
					'attributes'    	=> apply_filters( 'inventor_metabox_field_attributes', array(), $metabox_id, $field_id, $post_type ),
					'skip'              => true
				) );
