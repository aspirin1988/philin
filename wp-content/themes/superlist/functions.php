...
function superlist_enqueue_files() {
	...
	wp_enqueue_style( 'superlist', get_template_directory_uri() . '/assets/css/' . $style, array(), '2016051720' );
	wp_enqueue_style( 'style', get_stylesheet_directory_uri() . '/style.css', '2016051720' );
	...
	wp_enqueue_script( 'superlist', get_template_directory_uri() . '/assets/js/superlist.js', array( 'jquery' ), '20160502' );
}
...
add_action( 'inventor_listing_actions', 'superlist_render_favorite_button', 0, 1 );
